 ...
 *
 * 주기는 「하루 휴무 → 이틀 근무」가 3일마다 도는 형태이고 2026-08-01이 휴무다.
 *
 ...
 * 조회하는 것이 실제 흐름(기준 8/1, 조회 7월)이므로 **`Math.floorMod`를 쓴다.**
 */
object DispatchPatternExpander {
    /** 오프셋 0인 날. 이 날이 휴무다. */
    private val ANCHOR_DATE: LocalDate = LocalDate.of(2026, 8, 1)
